...
write.csv(inc_by_year_race, here("6_calculate_gini", "output", "race_ginis", "income_race.csv"), row.names = FALSE)
...
write.csv(wealth_nohouse_by_year_race, here("6_calculate_gini", "output", "race_ginis", "wealth_nohouse_race.csv"), row.names = FALSE)
...
write.csv(wealth_by_year_race, here("6_calculate_gini", "output", "race_ginis", "wealth_withhome_race.csv"), row.names = FALSE)
