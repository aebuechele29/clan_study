...
join_hh_clan <- function(hh_df, clan_df, var_label) {
  hh_df %>%
    ...
    write_csv(here("8_nuclear_family", "output", "all_nuclear_family",
...
pdf(file = file.path(here("8_nuclear_family", "output", "plots"),
...
print(
  doc,
  target = here("8_nuclear_family", "output", "all_nuclear_family",
