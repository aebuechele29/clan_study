...
# Appendix C: Alternative Inequality Measures {-}

```{r appendix-c, fig.width=14, fig.height=13, out.width="100%"}
appendix_c
```


# Appendix D1: Sensitivity — Negative Values {-}

```{r appendix-d1, fig.width=14, fig.height=11, out.width="100%"}
sensitivity_gini_1
```


# Appendix D2: Sensitivity — Wealth With and Without Home Equity {-}

```{r appendix-d2, fig.width=14, fig.height=7, out.width="100%"}
sensitivity_gini_2
```


# Appendix D3: Sensitivity — Single-Household Clans {-}

```{r appendix-d3, fig.width=14, fig.height=11, out.width="100%"}
sensitivity_gini_3
```


# Appendix D4: Sensitivity — Weighting {-}

```{r appendix-d4, fig.width=14, fig.height=11, out.width="100%"}
sensitivity_gini_4
```


# Appendix D5: Sensitivity — Size Standardization {-}

```{r appendix-d5, fig.width=14, fig.height=11, out.width="100%"}
sensitivity_gini_5
```


# Appendix D6: Gini Coefficients by Race Subgroup {-}

```{r appendix-d6, fig.width=14, fig.height=11, out.width="100%"}
sensitivity_gini_6
```


# Appendix E: Distribution of Income and Wealth {-}
...
# Appendix F1: Race Ratios — Negative Values {-}
...
```{r appendix-f2, fig.width=14, fig.height=7, out.width="100%"}
sensitivity_ratio_2
```


# Appendix F3: Race Ratios — Single-Household Clans {-}
...
# Appendix F4: Race Ratios — Weighting {-}
