...
$(h)$(o)clean_hs.rds: $(h)$(s)clean_households.R $(ch)$(o)households.rds $(fn)functions.R
    $(R)

# Step 5: Create clans
$(cc)$(o)clans.rds: $(cc)$(s)clans.R $(h)$(o)clean_hs.rds $(fn)functions.R
    $(R)

# Step 6: Clean clans
$(c)$(o)clean_clans.rds: $(c)$(s)clean_clans.R $(cc)$(o)clans.rds $(fn)functions.R
    $(R)

# Step 7: Analysis
$(an)$(o)analysis.pdf: $(an)$(s)analysis.R $(c)$(o)clean_clans.rds $(fn)functions.R \
$(h)$(o)clean_hs.rds
    $(R)
