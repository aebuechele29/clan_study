...
size_by_metric(
  ...
  save_pdf = TRUE,
  pdf_file = "8_clan_size/output/clan_size_income.pdf"
)
...
size_by_metric(
  ...
  save_pdf = TRUE,
  pdf_file = "8_clan_size/output/clan_size_wealth_nohouse.pdf"
)
...
size_by_metric(
  ...
  year = c(2009, 2019),
  save_pdf = TRUE,
  pdf_file = "8_clan_size/output/clan_size_wealth.pdf"
)
...
pdf("8_clan_size/output/in_data_income.pdf", width = 8, height = 6)
print(p_inc)
dev.off()
...
pdf("8_clan_size/output/in_data_wealth.pdf", width = 8, height = 6)
print(p_wealth)
dev.off()
...
pdf("8_clan_size/output/in_data_income_all.pdf", width = 8, height = 6)
print(p_inc_all)
dev.off()